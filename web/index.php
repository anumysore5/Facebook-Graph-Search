<?php
    ...
    if(isset($_GET['keyword']) and isset($_GET['type'])) {
        ...
        if($pageType == "place" and isset($_GET['latitude']) and isset($_GET['longitude'])) {
            ...
            $queryResult = "https://graph.facebook.com/v2.8/search?q=".$keyword."&type=".$pageType."&amp;center=".$centerValue."&fields=id,name,picture.width(700).height(700)&access_token=EAAGg2LWlrb8BAEc6HWrdKly0pAtKc09YCwJPsqS9fC1NEKX7oFFDukANXTGcIANyTZBhMYPmTLCZAocJNpZAqnmZCNEMCRbIlETHqXh69SSTsXnpnwPOGAjUV30ZBOCj03pY1x5EqQZAYzntzfKsju6KEa04ZCEEbkZD";
        } else {
            $queryResult = "https://graph.facebook.com/v2.8/search?q=".$keyword."&type=".$pageType."&fields=id,name,picture.width(700).height(700)&access_token=EAAGg2LWlrb8BAEc6HWrdKly0pAtKc09YCwJPsqS9fC1NEKX7oFFDukANXTGcIANyTZBhMYPmTLCZAocJNpZAqnmZCNEMCRbIlETHqXh69SSTsXnpnwPOGAjUV30ZBOCj03pY1x5EqQZAYzntzfKsju6KEa04ZCEEbkZD";
        }     
